...
class PokemonDetailsResponse extends Equatable {
  ...
  factory PokemonDetailsResponse.fromMap(Map<String, dynamic> data) =>
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [PokemonDetailsResponse].
  factory PokemonDetailsResponse.fromJson(String data) {
    return PokemonDetailsResponse.fromMap(
        json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [PokemonDetailsResponse] to a JSON string.
